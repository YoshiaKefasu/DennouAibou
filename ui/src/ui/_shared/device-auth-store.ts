/**
 * UI-local mirror of `src/shared/device-auth-store.ts`.
 *
 * Source of truth: `src/shared/device-auth-store.ts` (HEAD).
 */
import {
...
} from "./device-auth-types.ts";
export type { DeviceAuthEntry, DeviceAuthStore } from "./device-auth-types.ts";
