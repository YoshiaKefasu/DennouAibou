---
summary: "First-run setup flow for DennouAibou (macOS app)"
read_when:
...
- By default, DennouAibou is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give DennouAibou">
