...
DennouAibou uses Bonjour (mDNS / DNS‑SD) to discover an active Gateway (WebSocket endpoint).
...
DennouAibou supports any discovery domain; `openclaw.internal.` is just an example.
