---
summary: "Run DennouAibou on a Linux server or cloud VPS — provider picker, architecture, and tuning"
read_when:
  - You want to run the Gateway on a Linux server or cloud VPS
  - You need a quick map of hosting guides
  - You want generic Linux server tuning for DennouAibou
title: "Linux Server"
...
Run the DennouAibou Gateway on any Linux server or cloud VPS. This page helps you
