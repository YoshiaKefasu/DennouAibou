...
summary: "Default DennouAibou agent instructions and skills roster for the personal assistant setup"
read_when:
  - Starting a new DennouAibou agent session
  - Enabling or auditing default skills
---

# AGENTS.md - DennouAibou Personal Assistant (default)

## First run (recommended)

DennouAibou uses a dedicated workspace directory for the agent. Default: `~/.openclaw/workspace` (configurable via `agents.defaults.workspace`).
...
- For browser-driven verification, use `openclaw browser` (tabs/status/screenshot) with the DennouAibou-managed Chrome profile.
