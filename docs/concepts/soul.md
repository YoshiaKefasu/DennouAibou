---
summary: "Use SOUL.md to give your DennouAibou agent an actual voice instead of generic assistant sludge"
read_when:
...
DennouAibou injects it on normal sessions, so it has real weight. If your agent
...
For DennouAibou, `SOUL.md` is that layer.
...
Path fixed for DennouAibou workspaces: use `SOUL.md`, not `http://SOUL.md`.
