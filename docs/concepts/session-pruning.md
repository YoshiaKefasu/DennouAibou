...
DennouAibou also runs a separate idempotent cleanup for older legacy sessions that
...
DennouAibou auto-enables pruning for Anthropic profiles:
...
If you set explicit values, DennouAibou does not override them.
