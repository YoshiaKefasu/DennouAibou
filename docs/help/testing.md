...
DennouAibou has three Vitest suites (unit/integration, e2e, live) and a small set of Docker runners.
...
DennouAibou gateway container with the OpenAI-compatible HTTP endpoints enabled,
