---
summary: "Community-maintained DennouAibou plugins: browse, install, and submit your own"
read_when:
  - You want to find third-party DennouAibou plugins
...
Community plugins are third-party packages that extend DennouAibou with new
...
DennouAibou checks ClawHub first and falls back to npm automatically.

## Listed plugins

### Codex App Server Bridge

Independent DennouAibou bridge for Codex App Server conversations. Bind a chat to
...
Lossless Context Management plugin for DennouAibou. DAG-based conversation
...
Connect DennouAibou to QQ via the QQ Bot API. Supports private chats, group
...
WeCom channel plugin for DennouAibou by the Tencent WeCom team. Powered by
...
<Steps>
  ...
  <Step title="Use docs PRs only for source-doc changes">
    ...
    Open a docs PR only when DennouAibou's source docs need an actual content
