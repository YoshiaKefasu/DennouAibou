...
Nextcloud Talk ships as a bundled plugin in current DennouAibou releases, so
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "DennouAibou" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
