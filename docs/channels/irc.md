...
read_when:
  - You want to connect DennouAibou to IRC channels or DMs
  - You are configuring IRC allowlists, group policy, or mention gating
---

# IRC

Use IRC when you want DennouAibou in classic channels (`#room`) and direct messages.
...
Even if a channel is allowed (via `groupPolicy` + `groups`) and the sender is allowed, DennouAibou defaults to **mention-gating** in group contexts.
