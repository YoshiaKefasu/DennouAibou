...
It is modeled after Claude Code's `/btw` behavior, but adapted to DennouAibou's
...
If the main run is currently active, DennouAibou snapshots the current message
