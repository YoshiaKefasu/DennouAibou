...
DennouAibou can use **Firecrawl** in three ways:
...
DennouAibou always uses `proxy: "auto"` plus `storeInCache: true` for Firecrawl requests.
...
The selection knob is `tools.web.fetch.provider`. If you omit it, DennouAibou
