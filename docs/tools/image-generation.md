---
summary: "Generate and edit images using configured providers (OpenAI, Google Gemini)"
read_when:
...
OpenAI and Google support editing reference images. Pass a reference image path or URL:

```
"Generate a watercolor version of this photo" + image: "/path/to/photo.jpg"
```

OpenAI and Google support up to 5 reference images via the `images` parameter.
