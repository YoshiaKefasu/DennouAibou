---
summary: "DennouAibou Gateway CLI (`openclaw gateway`) — run, query, and discover gateways"
read_when:
...
The Gateway is DennouAibou’s WebSocket server (channels, nodes, sessions, hooks).
