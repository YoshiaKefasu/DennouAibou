...
read_when:
  ...
  - You need to cache completion scripts under DennouAibou state
title: "completion"
---
...
- `--install` writes a small "DennouAibou Completion" block into your shell profile and points it at the cached script.
