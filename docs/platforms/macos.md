---
summary: "DennouAibou macOS companion app (menu bar + gateway broker)"
read_when:
...
# DennouAibou macOS Companion (menu bar + gateway broker)

The macOS app is the **menu‑bar companion** for DennouAibou. It owns permissions,
...
1. Install and launch **DennouAibou.app**.
...
Avoid putting your DennouAibou state dir in iCloud or other cloud-synced folders.
...
- `swift run DennouAibou` (or Xcode)
