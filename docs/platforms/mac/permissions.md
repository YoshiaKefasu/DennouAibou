...
- Same path: run the app from a fixed location (for DennouAibou, `dist/DennouAibou.app`).
...
Workaround: move files into the DennouAibou workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.
