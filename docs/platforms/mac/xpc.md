---
summary: "macOS IPC architecture for DennouAibou app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# DennouAibou macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → DennouAibou.app → local execution.
