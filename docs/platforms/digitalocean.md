---
summary: "DennouAibou on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up DennouAibou on DigitalOcean
  - Looking for cheap VPS hosting for DennouAibou
title: "DigitalOcean (Platform)"
---

# DennouAibou on DigitalOcean

## Goal

Run a persistent DennouAibou Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
