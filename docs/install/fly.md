---
title: Fly.io
summary: "Step-by-step Fly.io deployment for DennouAibou with persistent storage and HTTPS"
read_when:
  - Deploying DennouAibou on Fly.io
  - Setting up Fly volumes, secrets, and first-run config
---

# Fly.io Deployment

**Goal:** DennouAibou Gateway running on a [Fly.io](https://fly.io) machine with persistent storage, automatic HTTPS, and Discord/channel access.
