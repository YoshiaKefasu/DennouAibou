...
// NOTE: ACP-specific thread binding reconciliation (reconcileAcpThreadBindingsOnStartup) was removed
// alongside the ACP plugin-sdk surface (see DENNOU_DOCS/DEBLOAT.md, Phase 20).
