...
declare const __DENNOU_VERSION__: string | undefined;
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["DENNOU_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["DENNOU_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["DENNOU_SERVICE_VERSION"],
...
export const VERSION = resolveBinaryVersion({
  ...
  injectedVersion: typeof __DENNOU_VERSION__ === "string" ? __DENNOU_VERSION__ : undefined,
  bundledVersion: process.env.DENNOU_BUNDLED_VERSION,
});
