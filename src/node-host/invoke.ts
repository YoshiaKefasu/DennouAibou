...
const execHostEnforced = process.env.DENNOU_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.DENNOU_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
