  ...
  return withEnvAsync(
    {
      ...
      DENNOU_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when DENNOU_VERSION is not set", async () => {
  ...
  it("prefers DENNOU_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over DENNOU_SERVICE_VERSION when DENNOU_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        DENNOU_VERSION: " ",
        DENNOU_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when DENNOU_VERSION and DENNOU_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        DENNOU_VERSION: " ",
        DENNOU_SERVICE_VERSION: "\t",
