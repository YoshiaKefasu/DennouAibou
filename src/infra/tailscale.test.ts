...
describe("tailscale helpers", () => {
  ...
  beforeEach(() => {
    envSnapshot = captureEnv(["DENNOU_TEST_TAILSCALE_BINARY", "NODE_ENV", "VITEST"]);
    process.env.DENNOU_TEST_TAILSCALE_BINARY = "tailscale";
  ...
  it("allows the test binary override in explicit test environments", () => {
    process.env.DENNOU_TEST_TAILSCALE_BINARY = "/tmp/test-tailscale";
  ...
  it("ignores the test binary override outside test environments", () => {
    process.env.DENNOU_TEST_TAILSCALE_BINARY = "/tmp/attacker-tailscale";
