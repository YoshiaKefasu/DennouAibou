  ...
  it.each([
    {
      ...
      expected: [
        ...
        "- state: ~/.dennou-aibou",
        "Skipped 1 path:",
        "- workspace: ~/Projects/openclaw (covered by ~/.dennou-aibou)",
        ...
        assets: [
          {
            ...
            displayPath: "~/.dennou-aibou/config.json",
          },
          {
            kind: "credentials",
            sourcePath: "/oauth",
            archivePath: "archive/oauth",
            displayPath: "~/.dennou-aibou/oauth",
          },
        ],
      }),
      expected: [
        backupArchiveLine,
        "Included 2 paths:",
        "- config: ~/.dennou-aibou/config.json",
        "- credentials: ~/.dennou-aibou/oauth",
