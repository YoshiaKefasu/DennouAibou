...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("dennou.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("dennou.contextEngineRegistryState");
