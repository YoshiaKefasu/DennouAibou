...
describe("detectMacCloudSyncedStateDir", () => {
  ...
  it("anchors cloud detection to OS homedir when DENNOU_HOME is overridden", () => {
    ...
    process.env.DENNOU_HOME = "/tmp/openclaw-home-override";
    ...
    try {
      ...
      if (originalOpenClawHome === undefined) {
        ...
        process.env.DENNOU_HOME = originalOpenClawHome;
      }
    }
  });
