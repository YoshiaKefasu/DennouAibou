export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_DENNOU_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_DENNOU_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[DENNOU_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[DENNOU_INTERNAL_CONTEXT_END]]";
