...
describeCacheLive("pi embedded runner prompt caching (live)", () => {
  beforeAll(async () => {
    ...
    previousCacheTraceEnv = {
      enabled: process.env.DENNOU_CACHE_TRACE,
      file: process.env.DENNOU_CACHE_TRACE_FILE,
      messages: process.env.DENNOU_CACHE_TRACE_MESSAGES,
      prompt: process.env.DENNOU_CACHE_TRACE_PROMPT,
      system: process.env.DENNOU_CACHE_TRACE_SYSTEM,
    };
    process.env.DENNOU_CACHE_TRACE = "1";
    process.env.DENNOU_CACHE_TRACE_FILE = liveCacheTraceFile;
    process.env.DENNOU_CACHE_TRACE_MESSAGES = "0";
    process.env.DENNOU_CACHE_TRACE_PROMPT = "0";
    process.env.DENNOU_CACHE_TRACE_SYSTEM = "0";
  }, 120_000);
  ...
  afterAll(async () => {
    if (previousCacheTraceEnv) {
      const restore = (
        key:
          | "DENNOU_CACHE_TRACE"
          | "DENNOU_CACHE_TRACE_FILE"
          | "DENNOU_CACHE_TRACE_MESSAGES"
          | "DENNOU_CACHE_TRACE_PROMPT"
          | "DENNOU_CACHE_TRACE_SYSTEM",
      ...
      restore("DENNOU_CACHE_TRACE", previousCacheTraceEnv.enabled);
      restore("DENNOU_CACHE_TRACE_FILE", previousCacheTraceEnv.file);
      restore("DENNOU_CACHE_TRACE_MESSAGES", previousCacheTraceEnv.messages);
      restore("DENNOU_CACHE_TRACE_PROMPT", previousCacheTraceEnv.prompt);
      restore("DENNOU_CACHE_TRACE_SYSTEM", previousCacheTraceEnv.system);
    }
