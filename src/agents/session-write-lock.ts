...
const CLEANUP_STATE_KEY = Symbol.for("dennou.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("dennou.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("dennou.sessionWriteLockWatchdogState");
