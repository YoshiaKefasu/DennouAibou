...
const PLUGIN_BINDING_PENDING_REQUESTS_KEY = Symbol.for("dennou.pluginBindingPendingRequests");
...
const pluginBindingGlobalStateKey = Symbol.for("dennou.plugins.binding.global-state");
