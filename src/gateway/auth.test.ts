...
describe("gateway auth", () => {
    ...
    expect(
      resolveGatewayAuth({
        ...
        env: {
          ...
          DENNOU_GATEWAY_PASSWORD: "env-password",
    ...
    expect(
      resolveGatewayAuth({
        authConfig: {
          ...
          password: "${DENNOU_GATEWAY_PASSWORD}",
        },
        env: {
          DENNOU_GATEWAY_TOKEN: "env-token",
          DENNOU_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides DENNOU_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        DENNOU_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
