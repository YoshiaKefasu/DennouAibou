...
beforeAll(async () => {
  envSnapshot = captureEnv(["DENNOU_GATEWAY_PORT", "DENNOU_GATEWAY_TOKEN"]);
  ...
  process.env.DENNOU_GATEWAY_PORT = String(gatewayPort);
  process.env.DENNOU_GATEWAY_TOKEN = gatewayToken;
