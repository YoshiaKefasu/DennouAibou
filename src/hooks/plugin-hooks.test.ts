...
describe("bundle plugin hooks", () => {
  ...
  beforeEach(async () => {
    ...
    previousBundledHooksDir = process.env.DENNOU_BUNDLED_HOOKS_DIR;
    process.env.DENNOU_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(() => {
    ...
    if (previousBundledHooksDir === undefined) {
      ...
      process.env.DENNOU_BUNDLED_HOOKS_DIR = previousBundledHooksDir;
    }
  });
