          ...
          return (async () => {
            ...
            try {
              const result = await runEmbeddedPiAgent({
                ...
                nativeAudioPaths: params.followupRun.run.nativeAudioPaths,
                nativeAudioTypes: params.followupRun.run.nativeAudioTypes,
                nativeAudioMimeType: params.followupRun.run.nativeAudioMimeType,
