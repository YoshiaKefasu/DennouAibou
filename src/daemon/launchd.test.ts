...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    ...
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", DENNOU_PROFILE: "default" },
    });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when DENNOU_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.openclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when DENNOU_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", DENNOU_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.openclaw.jbphoenix.plist",
    },
    {
      name: "prefers DENNOU_LAUNCHD_LABEL over DENNOU_PROFILE",
      env: {
        HOME: "/Users/test",
        DENNOU_PROFILE: "jbphoenix",
        DENNOU_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from DENNOU_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        DENNOU_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty DENNOU_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        DENNOU_PROFILE: "myprofile",
        DENNOU_LAUNCHD_LABEL: "   ",
      },
