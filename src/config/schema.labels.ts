...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "dennou.toolsPrune.keepLastAssistants": "Shared: Keep Last Assistant Turns",
  "dennou.toolsPrune.keepLastTools": "Shared: Keep Last Tools (deprecated)",
  "dennou.toolsPrune.placeholder": "Shared: Placeholder",
  ...
  "dennou.sessionToolsPrune.keepLastAssistants": "Session: Keep Last Assistant Turns",
  "dennou.sessionToolsPrune.keepLastTools": "Session: Keep Last Tools (deprecated)",
  ...
  "dennou.activeSessionToolsPrune.keepLastAssistants": "Active: Keep Last Assistant Turns",
  "dennou.activeSessionToolsPrune.keepLastTools": "Active: Keep Last Tools (deprecated)",
  ...
  "session.resetTriggers": "Session Reset Triggers (deprecated)",
  "session.idleMinutes": "Session Idle Minutes (deprecated)",
  "session.reset": "Session Reset Policy (deprecated)",
  "session.reset.mode": "Session Reset Mode (deprecated)",
  "session.reset.atHour": "Session Daily Reset Hour (deprecated)",
  "session.reset.idleMinutes": "Session Reset Idle Minutes (deprecated)",
  "session.resetByType": "Session Reset by Chat Type (deprecated)",
  "session.resetByType.direct": "Session Reset (Direct) (deprecated)",
  "session.resetByType.dm": "Session Reset (DM Deprecated Alias)",
  "session.resetByType.group": "Session Reset (Group) (deprecated)",
  "session.resetByType.thread": "Session Reset (Thread) (deprecated)",
  "session.resetByChannel": "Session Reset by Channel (deprecated)",
  ...
  "session.protectedKeys": "Protected Session Keys",
