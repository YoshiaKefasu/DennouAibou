...
beforeEach(() => {
  ...
  originalHideBanner = process.env.DENNOU_HIDE_BANNER;
  ...
  delete process.env.DENNOU_HIDE_BANNER;
});
...
afterEach(() => {
  ...
  if (originalHideBanner === undefined) {
    ...
    process.env.DENNOU_HIDE_BANNER = originalHideBanner;
  }
});
...
describe("registerPreActionHooks", () => {
  ...
  it("skips help/version preaction and respects banner opt-out", async () => {
    ...
    vi.clearAllMocks();
    process.env.DENNOU_HIDE_BANNER = "1";
