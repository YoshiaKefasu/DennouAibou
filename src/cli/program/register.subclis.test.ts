...
describe("registerSubCliCommands", () => {
  ...
  const originalDisableLazySubcommands = process.env.DENNOU_DISABLE_LAZY_SUBCOMMANDS;
  ...
  beforeEach(() => {
    if (originalDisableLazySubcommands === undefined) {
      delete process.env.DENNOU_DISABLE_LAZY_SUBCOMMANDS;
    } else {
      process.env.DENNOU_DISABLE_LAZY_SUBCOMMANDS = originalDisableLazySubcommands;
    }
