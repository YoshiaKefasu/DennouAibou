...
${formatHelpExamples([
  ...
  [
    "openclaw agents set-identity --workspace ~/.dennou-aibou/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "openclaw agents set-identity --identity-file ~/.dennou-aibou/workspace/IDENTITY.md --agent main",
